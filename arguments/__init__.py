...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.densify_grad_threshold_fine_init = 0.0005
        ...
        # for farc
        self.farc_loss_use = False
        self.farc_loss_until = 10000
        self.num_clusters = 1000
        self.lambda_knn_weight = 2000
        self.farc_loss_weight = 0.001
        self.farc_neighbor_num = 8
        #for entropyloss
        self.entropy_loss_weight = 0.005

        #for guide prune
        self.guide_pruning_use = False
        self.error_threshold = 0.2
        self.cam_distance_threshold = 8
        self.error_psnr_threshold = 36.00
        
        #for keypoint_add
        self.keypoint_add_use = True
        self.keypoint_from_iter = 2500
